...
export const SAMPLE_ROWS: readonly InboxRow[] = [
  {
    ...
    icon: 'alert',
    unread: true,
    heading: 'Plan atrasado en Finanzas',
  ...
  },
  {
    ...
    icon: 'report',
    unread: true,
    heading: 'Informe de la Encuesta de Clima Q3 listo',
  ...
  },
  {
    ...
    icon: 'survey',
    unread: true,
    heading: 'Encuesta de Clima Q3 cerró',
  ...
  },
  {
    ...
    icon: 'reminder',
    unread: false,
    heading: 'Recordatorio enviado · Encuesta de Clima Q3',
  ...
  },
  {
    ...
    icon: 'survey',
    unread: false,
    heading: 'Encuesta de Clima Q2 cerró',
  ...
  },
  {
    ...
    icon: 'report',
    unread: false,
    heading: 'Informe de la Encuesta de Clima Q2 listo',
