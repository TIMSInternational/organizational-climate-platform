...
/**
 * UNROUTED — kept as the wiring reference. `/admin/companies/:id` for a company administrator
 * now mounts `next/settings/CompanySettingsNextView` (the CompanySettings artboard, through the
 * role dispatcher in `CompanyDetailPage.tsx`); nothing in `app/router.tsx` imports this file.
 * It stays because its three independent loads and its department CRUD are the reference the
 * redesign was wired against, and its test still pins that behaviour.
 */
/**
 ...
 */
export default function CompanyDetailLegacyAdminPage() {
