...
public static class SurveyMapper
{
    ...
    private const string LegacyCommentPromptDefault = "Please explain your answer:";
    private const string LegacyBinaryLabelDefault = "Please explain your answer";
    private const string LegacyBinaryPlaceholderDefault = "Enter your explanation here...";
        ...
        LegacySurvey doc, string legacyId, string language, MappingContext context)
    {
        ...
        for (var index = 0; index < questions.Count; index++)
        {
            ...
            var commentPrompt = ScrubbedCommentPrompt(legacy.CommentPrompt, legacyId, field, report);
            var binaryConfig = ScrubbedBinaryConfig(legacy.BinaryCommentConfig, legacyId, field, report);
    ...
    private static string? ScrubbedCommentPrompt(string? raw, string legacyId, string field, DataQualityReport report)
    {
    ...
    private static string? ScrubbedBinaryConfig(
        LegacyBinaryCommentConfig? config, string legacyId, string field, DataQualityReport report)
    {
        if (config is null)
        {
            return null;
