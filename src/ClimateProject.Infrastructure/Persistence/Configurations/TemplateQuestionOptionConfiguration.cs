...
// never adopted it.
public class TemplateQuestionOptionConfiguration : IEntityTypeConfiguration<TemplateQuestionOption>
{
    public void Configure(EntityTypeBuilder<TemplateQuestionOption> builder)
    {
        builder.ToTable("template_question_options");
        builder.HasKey(o => new { o.TemplateQuestionId, o.Order });
        builder.Property(o => o.TemplateQuestionId).HasColumnName("template_question_id");
        ...
        builder.HasIndex(o => new { o.TemplateQuestionId, o.Value }).IsUnique();

        builder.HasOne<TemplateQuestion>().WithMany().HasForeignKey(o => o.TemplateQuestionId).OnDelete(DeleteBehavior.Cascade);
    }
}
