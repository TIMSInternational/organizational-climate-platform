    ...
    : DbContext(options)
{
    ...
    public DbSet<CompanyServiceLicense> CompanyServiceLicenses => Set<CompanyServiceLicense>();
    ...
    public DbSet<MicroclimateQuestionEmojiOption> MicroclimateQuestionEmojiOptions => Set<MicroclimateQuestionEmojiOption>();
